...
<div class="example-full">
  ...
  <h1 id="example-title" class="example-title">List Image</h1>
  ...
  <div class="upload" v-show="!isOption">
          ...
          <tr v-if="!files.length">
            <td colspan="9">
              <div class="text-center p-5">
                <label :for="name" class="btn btn-lg btn-primary">Select Images</label>
              </div>
            </td>
          </tr>
            ...
            <td>
              <div class="btn-group">
                ...
                <div class="dropdown-menu">
                  ...
                  <a class="dropdown-item" href="#" v-else-if="file.success" @click.prevent="sendImage(file)">Start Segmentation</a>
    ...
    <div class="example-foorer">
      <div class="btn-group">
        ...
        <div class="dropdown-menu">
          <label class="dropdown-item" :for="name">Add Images</label>
...
export default {
  ...
  methods: {
    ...
    console.log(file)
    axios.post('http://127.0.0.1:8000/segment', formData, {
        responseType: 'blob', 
        headers: {
    ...
    .then(response => {
      console.log(response)
        ...
        link.href = url;
        link.download = 'segmented_image.jpeg'; 
